...
$.jStorage.set('profile', {
	...
	'connection' : {
		...
		'http://www.wms.net/ontology/' : {
			description : {
				en : 'just a test'
			},
			useForInverseSameAs : true,
			/*change this*/
			endpoint : 'http://192.168.53.130:8890/sparql',
			//endpoint : 'http://192.168.0.107:8890/sparql',
			examples : [{
				label : 'test 1',
...
$.jStorage.set('boxTemplate', '<div  class="boxWrapper" id="first"  onclick="showNews(this)"><div class="box sprite"></div></div>');
...
{ 
	...
	//size=$.jStorage.get('profile').default.weblinks.properties.length;
	document.getElementById("iframeNews").setAttribute("src", element.getAttribute("rel"));
