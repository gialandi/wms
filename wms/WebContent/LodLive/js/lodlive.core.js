						...
						for (var akey in value) {
							if (filter == akey) {
								...
								try {
									var jSection = '';
									if (shortKey=='URL'){
										jSection = $("<div class=\"section\"><label data-title=\"" + akey + "\">" + shortKey + "</label><div><a href='"+unescape(value[akey])+"'>" + unescape(value[akey]) + "</a></div></div><div class=\"separ sprite\"></div>");
											
									}
									else{
									 jSection = $("<div class=\"section\"><label data-title=\"" + akey + "\">" + shortKey + "</label><div>" + unescape(value[akey]) + "</div></div><div class=\"separ sprite\"></div>");
									}
									jSection.find('label').each(function() {
										$(this).hover(function() {
											methods.msg($(this).attr('data-title'), 'show');
